    ...
    <Container id="home">
      <Slide direction="left">
        <Texts>
          ...
          <h1 className="green">Gleysmer Cedeño</h1>
          <h3>Web Developer Full Stack</h3>
          <p>
          I am a full stack web developer with knowledge in all aspects of web application
          ...
          <Social>
            ...
            <div className="social-icons">
              <span>
                <a href="https://www.instagram.com/gleiismeer/" target="_blank" rel="noreferrer">
                  <AiOutlineInstagram />
                </a>
              </span>
